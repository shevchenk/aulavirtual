...
@include( 'proceso.alumno.balotario.js.gestor_ajax' )
@include( 'proceso.alumno.balotario.js.gestor' )
@include( 'proceso.alumno.balotario.js.balotario_ajax' )
@include( 'proceso.alumno.balotario.js.balotario' )
...
@section('form')
@include( 'proceso.alumno.balotario.form.balotario' )
@stop
